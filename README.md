...
The output will be `path/to/folder[VT]` or modify the script to costumize output path.
...
You'll get your output at `path\to\dir[VT]` , or modify the path.
...
EVERY REFERENCES ARE TAKEN FROM OFFICIAL DOCS , ARTICLES AND BOOKS.
